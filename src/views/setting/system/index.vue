    ...
    <el-card shadow="never">
      <el-tabs tab-position="top">
        ...
        <el-tab-pane label="扩展配置">
            ...
            <el-table-column label="操作" fixed="right" width="120">
              <template #default="scope">
                <el-button-group>
                  ...
                  <el-button v-if="scope.row.isSet" text type="primary" size="small" @click="scope.row.isSet = false">
                    取消
                  </el-button>
          ...
          <el-button type="primary" icon="el-icon-plus" style="margin-top: 20px;" @click="table_add" />
        </el-tab-pane>
      </el-tabs>
    </el-card>
  </el-main>
