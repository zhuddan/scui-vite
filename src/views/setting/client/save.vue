    ...
    <el-form ref="dialogForm" :model="form" :rules="rules" label-width="100px" label-position="left">
      ...
      <el-form-item label="类型范围" prop="type">
        <el-checkbox-group v-model="form.type">
          <el-checkbox-button label="ALL" />
          <el-checkbox-button label="UPDATA" />
          <el-checkbox-button label="QUERY" />
          <el-checkbox-button label="INSERT" />
        </el-checkbox-group>
      </el-form-item>
      <el-form-item label="授权至" prop="exp">
        <el-date-picker v-model="form.exp" type="datetime" value-format="YYYY-MM-DD HH:mm:ss" placeholder="选择日期时间" />
      </el-form-item>
    </el-form>
    <template #footer>
