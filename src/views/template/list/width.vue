...
<template>
  <el-main class="sc-page">
    ...
    <el-card shadow="never" header="所有主机">
      ...
      <scTable ref="table" :data="data" height="auto" pagination-layout="total, prev, pager, next" hide-do>
        <el-table-column label="主机名称" prop="name" min-width="240" />
        <el-table-column label="外网ip" prop="ip" width="200" />
        <el-table-column label="系统盘" prop="c" width="150" />
        <el-table-column label="数据盘" prop="d" width="150" />
