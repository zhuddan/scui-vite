...
<template>
  <el-main>
    ...
    <el-card shadow="never" header="单选">
      <sc-table-select v-model="value2" :api-obj="apiObj" :params="params" :table-width="600" :props="props" @change="change">
    ...
    <el-card shadow="never" header="多选">
      <sc-table-select v-model="value" :api-obj="apiObj" :table-width="700" multiple clearable collapse-tags collapse-tags-tooltip :props="props" @change="change">
