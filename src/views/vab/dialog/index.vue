...
<template>
  <el-main>
    <el-alert title="二次封装el-dialog,加入加载中/最大化." type="success" style="margin:0 0 20px 0;" />
    ...
    <el-card shadow="never" header="异步" style="margin-top: 15px;">
      <el-button type="primary" @click="asyn1">
        异步加载1
      </el-button>
      <el-button type="primary" @click="asyn2">
        异步加载2
      </el-button>
  ...
  <sc-dialog v-model="dialog2" draggable title="模拟加载" :width="400" :loading="dialog2Loading">
    ...
    <template #footer>
      ...
      <el-button type="primary" :loading="dialog2Loading" @click="dialog2 = false">
        确 定
      </el-button>
    </template>
  </sc-dialog>
  ...
  <Dialog1 v-if="asynDialog1" draggable @closed="asynDialog1 = false" />
  <Dialog2 v-if="asynDialog2" draggable @closed="asynDialog2 = false" />
</template>
